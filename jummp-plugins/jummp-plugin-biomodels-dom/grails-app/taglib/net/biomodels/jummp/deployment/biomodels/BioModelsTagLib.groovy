...
class BioModelsTagLib {
    ...
    /**
     * Renders Model Browse features widget for the home page
     */
    def renderHomePageFeaturesModelBrowse = {
        ...
        total = decorationService.fetchStatisticsTotalParametersEntries()
        def totalParameterRecords = String.format("%,d", total)
        out << render(template: "/templates/biomodels/homePage/hp-features-model-browse",
                    model: [totalIndividualModels: totalIndividualModels,
                            ...
                            totalParameterRecords: totalParameterRecords])
    }
