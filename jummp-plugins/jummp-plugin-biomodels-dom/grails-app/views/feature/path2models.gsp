...
<head>
    ...
    <title>Path2Models Project page | BioModels</title>
</head>
...
<ul>
    <li><a href="#" title="Browse metabolic models">metabolic models</a></li>
    <li><a href="#" title="Browse non-metabolic models">non-metabolic models</a></li>
    <li><a href="#"
           title="Browse whole genome metabolism, constraint-based, models">whole genome metabolism models</a></li>
</ul>
...
completed. Models generated from other efforts are been added to this branch.
</p>
