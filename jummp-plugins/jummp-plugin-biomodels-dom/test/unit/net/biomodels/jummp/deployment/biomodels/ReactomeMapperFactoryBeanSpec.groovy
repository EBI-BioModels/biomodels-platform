...
class ReactomeMapperFactoryBeanSpec extends Specification {
    ...
    static doWithSpring = {
        reactomeMapperFactoryBean(ReactomeMapperFactoryBean)
    }

    def "test extraction of reactome pathway mapped to models" () {
        when: 'we request reactome mapper factory bean'
        ReactomeMapper reactomeMapper = grailsApplication.mainContext.getBean("reactomeMapperFactoryBean") as ReactomeMapper
