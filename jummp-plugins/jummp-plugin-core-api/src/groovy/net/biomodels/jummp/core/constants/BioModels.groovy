...
final class BioModels {
    ...
    static final String BM_ROOT_URL = "https://www.biomodels.org"
    ...
    static final String EBI_SEARCH_RESTFUL_WS_URL = "https://www.ebi.ac.uk/ebisearch/ws/rest"
    static final String FIXED_PARAMS = "query=*:*&size=0&facetfields"
    static final String IDENTIFIERS = "identifiers.org"
