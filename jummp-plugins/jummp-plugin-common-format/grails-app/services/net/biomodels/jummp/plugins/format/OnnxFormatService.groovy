 ...
 * <p>Individual class for handling the detection and manipulation of ONNX format. Read through
 * https://github.com/onnx/onnx for earning more details about this standard.</p>
 * <br/>
 ...
 * </ul>
 */
class OnnxFormatService extends AbstractFormatDetectionService {
    static transactional = false

    OnnxFormatService(CommonFormat expectedFormat = CommonFormat.ONNX) {
