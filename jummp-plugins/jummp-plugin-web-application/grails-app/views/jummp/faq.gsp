...
<div class="row">
    <div class="columns small-12 medium-12 large-12">
        ...
        <div class="faq-expand-all-bar">
            <button id="faq-expand-all-btn" class="button">Collapse All</button>
        </div>
    </div>
</div>

<ul class="accordion" id="faq-accordion" data-accordion data-multi-expand="true" data-allow-all-closed="true">

    <li id="what-is-biomodels-section" class="accordion-item is-active" data-accordion-item>
        <a href="#" class="accordion-title">I. What is BioModels and how does it differ from other resources?</a>
        <div class="accordion-content" data-tab-content>
            <div class="row">
                ...
                <div class="columns small-12 medium-10 large-10">
                    ...
                    <p>Besides this, BioModels has its own controlled annotation and vocabulary which allows users to search not
    ...
    <li id="citation-contact-info" class="accordion-item is-active" data-accordion-item>
        <a href="#" class="accordion-title">II. Citations and contact information</a>
        <div class="accordion-content" data-tab-content>
            <div class="row">
                <div class="columns small-12 medium-2 large-2">
                ...
                <div class="columns small-12 medium-10 large-10">
                    ...
                    <p>For your work about BioModels generally, please cite this paper.<br/>
                    ...
                    digits). Using the <a href="https://identifiers.org/" target="_blank">identifers.org</a> service to make a
                    link to your model. For example: https://identifiers.org/biomodels.db/MODEL2007280002
                    </p>
                    ...
                    <p>You can also refer to the information provided on the <a title="contact us page"
        ...
        <div class="accordion-content" data-tab-content>
            <div class="row">
                ...
                <div class="columns small-12 medium-10 large-10">
                    ...
                    <p>You can modify and freely distribute a modified version of a model that is present in BioModels in whole
                    or part. A modified model is the one where an existing model is extended/reduced/merged with other
    ...
    <li id="provided-features" class="accordion-item is-active" data-accordion-item>
        <a href="#" class="accordion-title">IV. Questions dealing with the provided features of BioModels</a>
        <div class="accordion-content" data-tab-content>
            <div class="row">
                <div class="columns small-12 medium-2 large-2">
                    <ol class="faq_subheading">
    ...
    <!-- MODEL SUBMISSION -->
    <li id="model-submission" class="accordion-item is-active" data-accordion-item>
        <a href="#" class="accordion-title">V. Questions dealing with model submission</a>
        <div class="accordion-content" data-tab-content>
            <div class="row">
                <!-- LEFT MENU -->
                <div class="columns small-12 medium-2 large-2">
                    <ol class="faq_subheading">
                        <li><a href="#submit-model">What do I need to submit a new model?</a>
                            <ol type="a">
                                <li><a href="#register-new-account"
                                       class="level3">How to register for a new user account?</a></li>
                        ...
                        <li>
                            ...
                            <ol type="a">
                                ...
                                <li><a href="#submit-no-publication"
                                       class="level3">What will happen if I submit the model without
                                ...
                                <li><a href="#changes-stored-revisions"
                                       class="level3">Are the model changes maintained as revisions?</a></li>
                            </ol>
                        </li>
                        <li><a
                        ...
                        <li><a
                            href="#submission-error">What do I do if I receive error messages when trying to submit a model?</a>
                        </li>
                    </ol>
                </div>
                ...
                <div class="columns small-12 medium-10 large-10">
                    ...
                    <p><strong>Notes</strong>: It takes 24 hours at the latest for your model to be indexed and appeared in
        ...
        <div class="accordion-content" data-tab-content>
            <div class="row">
                ...
                <div class="columns small-12 medium-10 large-10">
                    ...
                    distributed under the GNU General Public Licence. For more information, please refer to the <a
                    ...
                    <p>All converters are also available under an open source licence and can be downloaded from the <a
    ...
    $(document).ready(function () {
        ...
        $('#faq-expand-all-btn').on('click', function () {
            ...
            if (anyOpen) {
                ...
                $('#faq-accordion .accordion-content').each(function () {
                    $('#faq-accordion').foundation('down', $(this));
                });
            }
        });
    });
