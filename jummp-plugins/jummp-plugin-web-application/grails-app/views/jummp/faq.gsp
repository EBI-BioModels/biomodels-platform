...
<!-- ####################################################################### -->
<h2 id="WHAT_IS_BIOMDB">What is BioModels?</h2>
...
<h2 id="ORIGINAL_AUTHOR">I wish to contact the original author(s) of a model, but the listed email does not work.
What should I do?</h2>
...
<h2 id="MODEL_REUSE">What are the conditions of use and distribution for unmodified models originating from BioModels
Database?</h2>
...
<h2 id="MODEL_MODIFY">What are the conditions of use and distribution for modified models that originated from
BioModels Database?</h2>
...
<p></p>
<!-- ############################################################# -->
<h2 id="BIOMDB_SOFTWARE">What are the tools used to develop and run the software infrastructure behind BioModels
Database?</h2>
