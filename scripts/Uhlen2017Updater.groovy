...
class UhlenModelUpdater {
    ...
    Revision doInsertNewRevision(String modelId, File modelFolder, Model model) {
        ...
        List<RepoFTC> filesToAdd = revisionData.toAdd as List<RepoFTC>
        List<RepoFTC> filesToDelete = revisionData.toDelete as List<RepoFTC>
    ...
    static RepoFTC createRepoFile(File file, boolean isMainFile, String description) {
    ...
    Map<String, Object> createRevisionCmdForModelFolder(String id, File folder, Model model) {
        ...
        RepoFTC modelFile = repoFileMap.main as RepoFTC
        List<RepoFTC> additionals = repoFileMap.additionals as List<RepoFTC>
