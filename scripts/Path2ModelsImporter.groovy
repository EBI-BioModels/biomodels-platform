...
String lookupAutoGeneratedCategory(String modelId) {
    ctx.p2mService.getCategoryForModel modelId
}
...
RevisionTransportCommand createRevisionCmdForModelFolder(String id, File folder) {
    ...
    String modelCategory = lookupAutoGeneratedCategory id
    def mainFileRFTC = createRepoFile(modelFile, true, "Path2Models entry for $modelCategory")
    def otherRepoFiles = additionals.collect { f ->
        createRepoFile f, false, "All files for $modelCategory"
    }
