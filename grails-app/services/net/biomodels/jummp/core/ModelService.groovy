...
${model.vcsIdentifier} added to VCS, but not stored in database""")
     ...
     */
    List<String> getAllModelIdentifiers(final boolean isPrivate = false, final isAutogenerated = false) {
        if (isAutogenerated) {
