...
"""
    ...
    List<String> getAllModelIdentifiers(final boolean isPrivate = false, final boolean isAutogenerated = false) {
        modelService.getAllModelIdentifiers(isPrivate, isAutogenerated)
    }
