...
log4j.main = {
    ...
    appenders {
        ...
        def performanceGraphFileAppender = new org.apache.log4j.FileAppender(
            fileName: "${logDir}/perfGraphs.log",
        ...
        rollingFile name: "jummpAppender", file: "${logDir}/jummp-core.log", threshold: org.apache.log4j.Level.WARN
        rollingFile name: "eventsAppender", file: "${logDir}/jummp-events.log", threshold: org.apache.log4j.Level.DEBUG
    ...
    rollingFile name: "debugAppender", file: "${logDir}/jummp-debug.log", threshold: org.apache.log4j.Level.DEBUG
    rollingFile name: "hibernateAppender", file: "${logDir}/jummp-hibernate.log", threshold: org.apache.log4j.Level.WARN
