...
class UrlMappings {
    ...
    static mappings = {
        ...
        "/curation-docs/annotation"(controller: "jummp", action: "annotationInfo")
        "/curation-docs/annotation-tips"(controller: "jummp", action: "annotationTips")
        // Legacy paths from the old EBI-hosted BioModels platform (JBM-557)
        "/annotation"(redirect: [uri: "/curation-docs/annotation", permanent: true])
        "/annotationtips"(redirect: [uri: "/curation-docs/annotation-tips", permanent: true])
